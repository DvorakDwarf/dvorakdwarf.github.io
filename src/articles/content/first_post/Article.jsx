    ...
    <div className="first_post">
     ...
     <article>
      ...
      <p>For the first note here I'll just record some things related to making   this website</p>
        ...
        <p>On top of trying to do webdev for the first time in my life I thought I might as well layer more stuff on top of it. I've heard Vim people rave about how it's the best thing since sliced bread and the transistor, but the final drop was sitting on a call with a person helping me figure out a code problem and seeing them use Vim keybindings. They looked like a wizard and now I wanna do the same. Also customization. A big part was customization. Same as with Linux. Entirely because I wanted a pretty desktop.</p>
        <h2>Making the website itself</h2>
        <p>I had never touched web anything until about 2 months ago. I was going and checking out other people's websites and decided that the time has come for me to get one of my own. Looking at webrings helped.</p>
        {/* <Codeblock /> */}
        {/* <span>Sorting by date so that react can pick 2 most recent articles to display on the home page</span> */}
        <h2>Hosting</h2>
        <p>Pictured below is the hunk of junk I was planning on keeping this website in. After some intense 10 minutes of googling, I found out it's very much not a recommended thing to do. I briefly looked into different hosting services. I was getting quite tired so I settled on using Github Pages and it turned out pretty well. Unfortunately, my sad little backend had to be scrapped because it would not work with Github Pages. I ended up making a <code>json</code> containing all relevant info which is not a deal breaker but sad nonetheless</p>
        <img src={require('./images/PC.jpg')}></img>
        <span>The door is broken and can't be closed</span>
        <h2>how do i store file</h2>
        <p>As a complete noob, for some time I got stuck on how to store the articles. I didn't know whether this is where the backend starts and I get to manage a database or whether I am overthinking. Maybe there is another way of storing it. For example, the developer I took zero inspiration from fetches their posts from cohost which is kinda smart (2026 update: ;( ).</p>
        <p>While I was thinking about this my storage corrupted and ate all my code.</p>
