    ...
    <div className="wrapper">
     <article>
      ...
      <main>  
        ...
        <h2>The software</h2>
        <p>I tried running Minbitt's code and it worked fine but I wanted more. The controls using an accelerometer were quite incovenient and I wanted to change it since I planned on going to a con with it. (Also the code was outdated what's in the video I think). I saw that the M4 had Bluetooth Low Power, so I could control the board remotely from my phone. There is a weird problem with the board that causes it to go from 60fps 4k Ultra HD Dolby digital audio to 1fps if you are connected with BLE and that sucks. I dealt with the problem by ignoring it and just disconnecting from it when I don't need to change faces</p>
        <p>The bluefruit BLE app I used has a control pad and it's got 4 arrows and 4 buttons. I numbers to pick different faces/options and the arrows to pick between 3 different face sets and the options set, where I can control THE GLITCHES</p>
        <h2>THE GLITCHES</h2>
        <p>I love glitch visual effects. I think the look cool as hell and I wanted some of that on my TV head. Due to the limited number buttons and me not wanting to change the effects periodically I decided to set the helmet to automatic mode. This way different glitches would occur randomly. This would turn off when I manually change faces</p>
        <p>While making these I also found out the limitatiosn of the Matrixportal M4. These visual effects aren't instant and there is a visible "scanline" of sorts which to me just adds to the aesthetic. Some glitches I added are: jitter, dissapearing rows, random color rows, random palette, full screen garble before reset, and possibly something else I am forgetting. Partially inspired by the boombot screen from <a href='https://www.youtube.com/watch?v=DBDspsbNKRo'>this</a> video</p>
        <h2>The final product</h2>
        <p>WIP I am still building the thing lol</p>
      </main>
    </article>
    </div>
  );
