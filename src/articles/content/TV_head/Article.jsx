    ...
    <div className="TV_head">
     ...
     <article>
      ...
      <main>  
        ...
        <h2>The helmet</h2>
        <p>I happen to own a pretty sweet 3D printer gifted to me from a program I participated in and as a result, decided that printing the case would be the best. One glaring issue arose immediately. That of my lack of skill with 3D modeling. I am gonna be honest. Either the 3D model files weren't in the tutorial zip from the youtube video or I might be blind because I did not find the 3D model they used in the video. That is why I decided to make my own 3D model despite never having seriously done CAD before. I decided to use FreeCAD and my experience has been mixed at best. I don't know enough about CAD to give a real review but the process of trying to do anything outside of making a sketch and then padding it felt like pulling teeth</p>
